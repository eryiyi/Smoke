...
/**
 */
public class MineTalkAdapter extends BaseAdapter {
    ...
    public MineTalkAdapter(List<TalkObj> lists, Context mContext) {
        this.lists = lists;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_mine_talk_adapter, null);
            holder.item_name = (ImageView) convertView.findViewById(R.id.item_name);
...
//        holder.item_dateline.setText(cell.getnRegisterDate() ==null?"":cell.getnRegisterDate());
