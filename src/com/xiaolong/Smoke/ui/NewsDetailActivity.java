...
import com.xiaolong.Smoke.data.NewsSingleData;
                        ...
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                if(Integer.parseInt(code) == 200) {
                                    ...
                                    Toast.makeText(NewsDetailActivity.this, jo.getString("msg"), Toast.LENGTH_SHORT).show();
                                }
